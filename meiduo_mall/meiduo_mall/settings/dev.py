...
QQ_REDIRECT_URL = 'http://www.meiduo.site:8080/oauth_callback.htmls'
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /Users/python/Desktop/meiduo_mall/meiduo_mall/logs/crontab.log')
]
